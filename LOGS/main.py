...
def main():
    ...
    try:
        ...
        pal = QPalette()
        pal.setColor(QPalette.Window,          QColor(17,  17,  20))
        pal.setColor(QPalette.WindowText,      QColor(220, 220, 232))
        pal.setColor(QPalette.Base,            QColor(26,  26,  30))
        pal.setColor(QPalette.AlternateBase,   QColor(34,  34,  42))
        pal.setColor(QPalette.Text,            QColor(220, 220, 232))
        pal.setColor(QPalette.Button,          QColor(26,  26,  30))
        pal.setColor(QPalette.ButtonText,      QColor(220, 220, 232))
